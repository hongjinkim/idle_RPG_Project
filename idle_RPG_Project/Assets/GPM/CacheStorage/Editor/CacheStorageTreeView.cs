...
{
    using Internal;
    public class CacheStorageTreeView : TreeView<int>
    {
        ...
        public CacheStorageTreeView(TreeViewState<int> state, MultiColumnHeaderState multiColumnHeader) : base(state, new MultiColumnHeader(multiColumnHeader))
        {
            showBorder = true;
        ...
        protected override bool CanMultiSelect(TreeViewItem<int> item) { return false; }
