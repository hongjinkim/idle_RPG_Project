...
namespace DataTable
{
    ...
    { 
        ...
        public delegate void OnLoadedFromGoogleSheets(List<Weapon> loadedList, Dictionary<int, Weapon> loadedDictionary);
...
/* Your Loaded Data Storage. */
        ...
        /// - Auto Load
        /// </summary>
        public static Dictionary<int, Weapon>  GetDictionary()
        {{
           if (isLoaded == false) Load();
           return WeaponMap;
        }}
...
#region fuctions
        ...
        public static void LoadFromGoogle(System.Action<List<Weapon>, Dictionary<int, Weapon>> onLoaded, bool updateCurrentData = false)
        {      
    ...
    public static (List<Weapon> list, Dictionary<int, Weapon> map) CommonLoad(Dictionary<string, Dictionary<string, List<string>>> jsonObject, bool forceReload){
            Dictionary<int, Weapon> Map = new Dictionary<int, Weapon>();
