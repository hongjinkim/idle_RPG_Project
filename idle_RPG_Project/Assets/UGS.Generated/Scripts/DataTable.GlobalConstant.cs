...
namespace DataTable
{
    ...
    { 
        ...
        static string sheetID = "1354079166"; // it is sheet id
...
/* Your Loaded Data Storage. */
        ...
        /// <summary>
        /// Get GlobalConstant List 
        /// Auto Load
        /// </summary>
        public static List<GlobalConstant> GetList()
        {{
           if (isLoaded == false) Load();
           return GlobalConstantList;
        }}
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            {
#if UGS_DEBUG
                 Debug.Log("GlobalConstant is already loaded! if you want reload then, forceReload parameter set true");
#endif
                 return;
            }
    ...
    public static (List<GlobalConstant> list, Dictionary<string, GlobalConstant> map) CommonLoad(Dictionary<string, Dictionary<string, List<string>>> jsonObject, bool forceReload){
            ...
            var sheet = jsonObject["GlobalConstant"];
          ...
          // 실제 데이터 로드
                    if (rows.Count != 0)
                    {
                        ...
                        {
                            GlobalConstant instance = new GlobalConstant();
        ...
        public static void Write(GlobalConstant data, System.Action<WriteObjectResult> onWriteCallback = null)
        { 
            TypeMap.Init();
            FieldInfo[] fields = typeof(GlobalConstant).GetFields(BindingFlags.Public | BindingFlags.Instance);
